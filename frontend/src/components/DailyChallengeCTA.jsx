...
export default function DailyChallengeCTA({ userId, onAccept, onDismiss }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display:'inline-block', background:'rgba(251,191,36,0.12)', border:'1px solid rgba(251,191,36,0.3)', borderRadius:99, padding:'5px 14px', fontSize:15, fontWeight:800, color:'#fbbf24', letterSpacing:'.1em', marginBottom:20, fontFamily:"'Syne',sans-serif" }}>
          ✦ TODAY&apos;S CHALLENGE
        </div>

        <div style={{ width:80, height:80, borderRadius:24, background:'linear-gradient(135deg, rgba(251,191,36,0.2), rgba(245,158,11,0.1))', border:'1.5px solid rgba(251,191,36,0.35)', boxShadow:'0 0 24px rgba(251,191,36,0.2)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:43, margin:'0 auto 18px', animation:'challengePulse 2.5s ease-in-out infinite' }}>
          {challenge.emoji}
        </div>

        <h2 style={{ margin:'0 0 8px', fontSize:29, fontWeight:800, color:'#fde68a', fontFamily:"'Syne',sans-serif", lineHeight:1.2 }}>
          {challenge.label}
        </h2>
        <p style={{ margin:'0 0 6px', fontSize:20, color:'#a78bfa', lineHeight:1.5, fontWeight:500 }}>
          {challenge.desc}
        </p>

        <div style={{ display:'inline-flex', alignItems:'center', gap:6, background:'rgba(251,191,36,0.12)', border:'1px solid rgba(251,191,36,0.25)', borderRadius:12, padding:'7px 16px', margin:'14px 0 24px', fontSize:21, fontWeight:800, color:'#fbbf24', fontFamily:"'Syne',sans-serif" }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:10 }}>
          <button
            ...
            style={{ width:'100%', padding:'14px', background:'linear-gradient(135deg, #f59e0b, #fbbf24)', border:'none', borderRadius:16, color:'#1a0f00', fontSize:20, fontWeight:800, cursor:'pointer', fontFamily:"'DM Sans',sans-serif", boxShadow:'0 6px 24px rgba(251,191,36,0.35)', transition:'transform .15s, box-shadow .15s' }}
